          ...
          <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1">
              <div class="box box-warning">
                <div class="box-body">
                {!! Form::model($post, ['route' => ['songs.update', $post->id], 'method' => 'PUT', 'files' => true]) !!}
                    <!-- text input -->
                    ...
                    {{ Form::submit('Edit the song', ['class' => 'btn btn-success btn-lg btn-block'])}}
