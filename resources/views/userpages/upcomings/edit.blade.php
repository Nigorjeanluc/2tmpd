...
@section('pageview')
      <h1>
        Dashboard
        <small>Edit this Upcoming event</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1">
              <div class="box box-warning">
                <div class="box-body">
                {!! Form::model($post, ['route' => ['upcoming.update', $post->id], 'method' => 'PUT', 'files' => true]) !!}
                    <!-- text input -->
                    ...
                    {{ Form::submit('Edit the Upcoming Event', ['class' => 'btn btn-success btn-lg btn-block'])}}
                {!! Form::close() !!}
                </div>
                <!-- /.box-body -->
              </div>
