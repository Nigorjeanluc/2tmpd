...
<!-- breadcrumbs -->
    ...
    <div class="latest-albums">
        <div class="container">
            <h3 class="agileits_w3layouts_head"><span>Charity donation</span></h3>
            <div class="grid_3 grid_5 agile">
                <div style="font-family: cursive; font-size:1.2em;text-align: justify" class="panel panel-success">
                    <div class="panel-body">
                    <img class="img-responsive" style="float:left;width:350px;margin-right: 10px" src="images/charity3.jpg" /> 2T was born on 1st August,1984 in Rwanda; being born in a family of singers( father, mother and siblings) 2T got a chance to practice and perform almost
                    ...
                    group), T Sol.<br /><br /><img class="img-responsive" style="float:left;width:350px;margin-right: 10px" src="images/charity2.jpg" />During genocide in 1994 at the age of 9 years, 2T (Rwanda reggae artist) lost his five brothers and his father so he survived with only his mother and 2 sisters, this led 2T to drop school for 2 years as he
                    ...
                    <img class="img-responsive" style="float:right;width:300px;margin-left: 10px" src="images/charity1.jpg" />Even though difficulties here and there trying to hustle for life, 2T’s music passion didn’t stop, eventhough music was not found to be a productive profession
